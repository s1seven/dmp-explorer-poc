...
export class CreateCompaniesAndInvitations1712846805692 implements MigrationInterface {
    name = 'CreateCompaniesAndInvitations1712846805692'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "batch_entity" DROP CONSTRAINT "FK_76cb8d9bfefa4fe71c2986db6a0"`);
        ...
        await queryRunner.query(`ALTER TABLE "batch_entity" ADD "parentLotNumber" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "batch_entity" DROP COLUMN "companyId"`);
        await queryRunner.query(`ALTER TABLE "batch_entity" DROP COLUMN "parentLotNumber"`);
        ...
        await queryRunner.query(`ALTER TABLE "batch_entity" ADD CONSTRAINT "FK_76cb8d9bfefa4fe71c2986db6a0" FOREIGN KEY ("ownerId") REFERENCES "user_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
